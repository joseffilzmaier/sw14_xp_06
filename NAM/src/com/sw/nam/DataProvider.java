...
public class DataProvider extends ContentProvider {
	...
	static {
		...
		uriMatcher.addURI("com.sw.nam.provider", "messages", MESSAGES_ALLROWS);
		uriMatcher.addURI("com.sw.nam.provider", "messages/#", MESSAGES_SINGLE_ROW);
		uriMatcher.addURI("com.sw.nam.provider", "profile", PROFILE_ALLROWS);
		uriMatcher.addURI("com.sw.nam.provider", "profile/#", PROFILE_SINGLE_ROW);
	}
	...
	private static class DbHelper extends SQLiteOpenHelper {
		private static final String DATABASE_NAME = "nam.db";
